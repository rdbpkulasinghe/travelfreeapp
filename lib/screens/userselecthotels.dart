...
import 'package:travelfreeapp/screens/home_page.dart'; // Add this import for DateFormat

class UserSelecthotel extends StatelessWidget {
  const UserSelecthotel({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('User select hotel'),
        leading: IconButton(
                    ...
                    children: [
                      Padding(
                        ...
                        child: CarouselSlider(
                          ...
                          items: hotel['imageUrls'].map<Widget>((imageUrl) {
                            return Builder(
